...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (320, 120, 160)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
...
class Game(AbstractGame):
    def __init__(self, seed=None):
        ...
        self.game.init()
        self.observation_shape = (320, 120, 160)
    ...
    def get_observation(self):
        ...
        """
        state = self.game.get_state().screen_buffer
        observation = cv2.resize(state, (160, 120), interpolation=cv2.INTER_AREA)
